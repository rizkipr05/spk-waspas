...
<div class="mb-3 d-flex justify-content-between align-items-center">
    <div>
        <h4 class="fw-semibold mb-1">Tambah Influencer</h4>
        <p class="text-muted mb-0 small">
            Masukkan data influencer yang akan digunakan dalam proses perhitungan SPK.
        </p>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="followers" class="form-control form-control-sm"
                           value="{{ old('followers', 0) }}" min="0" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="engagement_rate"
                           ...
                           value="{{ old('engagement_rate') }}" min="0" max="100"
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="niche" class="form-control form-control-sm"
                           value="{{ old('niche') }}" placeholder="fashion, tech, food, dll">
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="url" name="profile_link" class="form-control form-control-sm"
                           value="{{ old('profile_link') }}" placeholder="https://instagram.com/...">
                </div>

                <div class="col-12">
                    <label class="form-label small">Catatan Tambahan</label>
                    <textarea name="notes" rows="3" class="form-control form-control-sm"
                              placeholder="Catatan tentang kualitas konten, kerjasama sebelumnya, dll.">{{ old('notes') }}</textarea>
                </div>
            </div>
